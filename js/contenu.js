function metadonnees(article) {
  ...
  <!-- Autres balises méta -->
  <title>- Actus - ${article["date"].getFullYear()} / ${
      article["title"]
    }</title>
...
function contenu_article(contenu, infos) {
  ...
  for (let i = 0; i < contenu.length; i++) {
    if (contenu[i][0] == "p") {
      ...
      for (let i2 = 0; i2 < contenu[i][1].length; i2++) {
        article =
          article +
          `      <div class="image_container"><img alt="${contenu[i][1][i2][0]}" src="${contenu[i][1][i2][1]}"></div>\n`;
      }
      article = article + `    </div>` + "\n";
  ...
  document
    .getElementsByClassName("Article_Infos")[0]
...
const eiyuden = [
  [
    "p",
    [
      `À l'occasion du Nintendo Direct du 14 septembre 2023, Eiyuden Chronicle: Hundred Heroes dévoile enfin 
  ...
  [
    "p",
    [
      `Annoncé en 2020, le projet Eiyuden Chronicle est porté par une campagne de financement participatif sur 
  ...
  [
    "p",
    [
      `Ce n'est pas le seul JRPG qui aura fait l'objet d'une annonce lors de ce Nintendo Direct, puisqu'on
...
const atlas = [
  [
    "p",
    [
      `Salut à tous, mes chers gamers ! Le jour tant attendu est enfin arrivé ! "Atlas Fallen" débarque sur nos
  ...
  [
    "p",
    [
      `Développé par les maestros de Focus Entertainment et Deck 13, "Atlas Fallen" nous plonge dans un monde
...
const star_ocean = [
  [
    "p",
    [
      `Le <span class="Article_Span">2 novembre 2023</span> marquera le retour d'un classique du <span
  ...
  [
    ...
    [
      [
        "Image de la lune",
        "https://starocean2r.square-enix-games.com/_next/image/?url=%2F_next%2Fstatic%2Fmedia%2Fplanet.6ff9ef82.png&w=3840&q=75",
      ],
    ],
  ],
  [
    "p",
    [
      `L'histoire suit les aventures de <span class="Article_Span">Claude C. Kenny</span>, un officier 
  ...
  [
    ...
    [
      [
        "Artwork de Claude et Rena",
        "https://starocean2r.square-enix-games.com/_next/image/?url=%2F_next%2Fstatic%2Fmedia%2Fcharacters.bb559667.png&w=3840&q=100",
      ],
    ],
  ],
  [
    "p",
    [
      `Le jeu offre une expérience de <span class="Article_Span">combat en temps réel</span>, avec de 
  ...
  [
    "p",
    [
      `<span class="Article_Span">Star Ocean: The Second Story R</span> est sans aucun doute un titre à
  ...
  [
    ...
    [
      [
        "Screen Combat",
        "https://img.playstationtrophies.org/images/monthly_2023_06/screenshots/22632/med_star_ocean_the_second_story_r_vvol1.9_2d5997ff-d2a0-4f04-bfad-233e08b3fe8b.jpg",
      ],
      [
        "Screen Ville",
        "https://img.playstationtrophies.org/images/monthly_2023_06/screenshots/22632/med_star_ocean_the_second_story_r_vol1_1b75883c-781d-47e2-b6b2-8805df301930.jpg",
      ],
      [
        "Screen Ville",
        "https://img.playstationtrophies.org/images/monthly_2023_06/screenshots/22632/med_star_ocean_the_second_story_r_vol1.2_ccab05d9-b0db-413c-a78c-4d582869d2b8.jpg",
      ],
      [
        "Screen Ville",
        "https://gh.cdn.sewest.net/assets/ident/news/23a6ae4d/Vol1_p17_%E8%A1%972-mxky7lbxw.jpg?quality=65",
      ],
...
const sea_stars = [
  [
    "p",
    [
      `Sea Of Stars, un nouveau RPG au tour par tour , par Sabotage Studio, vera le jour le
  ...
  [
    ...
    [
      [
        "Artwork du jeu",
        "https://h7j8r4f2.stackpathcdn.com/wp-content/uploads/2022/05/sea-of-stars-GI-cover-gold-1966x1285.jpg.webp",
      ],
    ],
  ],
  [
    "p",
    [
      `Sea of Stars nous plonge dans un univers riche et détaillé, où deux Enfants du Solstice, Valere
  ...
  [
    ...
    [
      [
        "Artwork des personnages",
        "https://h8d9s2y4.stackpathcdn.com/wp-content/uploads/2020/04/img-characters-art-2@2x.png",
      ],
    ],
  ],
  [
    "p",
    [
      `Leur dualité est au cœur du système de combat, offrant une profondeur stratégique et une variété 
  ...
  [
    "img",
    [
      ["Photo d'Eric W.Brow", "https://f4.bcbits.com/img/0018719815_25.jpg"],
      [
        "Photo de Mitsuda",
        "https://upload.wikimedia.org/wikipedia/commons/b/b1/Yasunori_Mitsuda_%282019%29.jpg",
      ],
    ],
  ],
  [
    "p",
    [
      `Le jeu est une préquelle de "The Messenger", un autre titre populaire de Sabotage Studio.`,
  ...
  [
    "p",
    [
      `Il est à noter que Sabotage Studio a réussi à récolter près de 1,000,000€ sur Kickstarter en
  ...
  [
    ...
    [
      [
        "image world map",
        "https://h7j8r4f2.stackpathcdn.com/wp-content/uploads/2022/03/World-2-1070x602.png.webp",
      ],
      [
        "image combat",
        "https://h7j8r4f2.stackpathcdn.com/wp-content/uploads/2023/04/Screenshot-2023-03-31-13-59-25-1070x602.png.webp",
      ],
    ],
  ],
];
...
const lost_soul = [
  [
    "p",
    [
      `<span class="Article_Span">Lost Soul Aside</span> est un jeu vidéo d'action et de rôle en
  ...
  [
    ...
    [
      [
        "Image de Lost Soul Aside",
        "https://i.ytimg.com/vi/z5El-yYNUwU/maxresdefault.jpg",
      ],
    ],
  ],
  ...
  [
    "p",
    [
      `Le projet <span class="Article_Span">Lost Soul Aside</span> a été initié par <span
  ...
  [
    "p",
    [
      `Selon les dernières informations partagées sur <span class="Article_Span"><a 
  ...
  [
    "p",
    [
      `Bien que la date de sortie exacte ne soit pas encore connue, l'anticipation pour <span
  ...
  [
    ...
    [
      [
        "Image de Lost Soul Aside",
        "https://image.jeuxvideo.com/images/videos/news-images/l/o/lost-soul-aside-18-minutes-de-gameplau-1356705-1619513216-high.jpg",
      ],
      [
        "Image de Lost Soul Aside",
        "https://d3kjluh73b9h9o.cloudfront.net/original/3X/a/d/ad718032bb100cb9fcea68918407b0cfabf9c0cb.jpeg",
      ],
      [
        "Image de Lost Soul Aside",
        "https://www.destructoid.com/wp-content/uploads/2021/05/627343-LostSoulAside_Lead_042721.jpg",
      ],
      [
        "Image de Lost Soul Aside",
        "https://www.gaming.net/wp-content/uploads/2023/04/Lost-Soul-Aside_2021_04-26-21_003.jpg",
      ],
    ],
  ],
];

const star_ocean_flashback= [
];
