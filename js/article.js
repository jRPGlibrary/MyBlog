...
function article_infos (actus_liste) {
    ...
    Infos_Date.innerHTML = '<img class="Info_Icon" alt="Date" src="../../../images/calendar.png"> '+' Crée le'+affiche_date(actus_liste[index]["date"]);
    const Infos_Temps = document.getElementsByClassName("Infos_Temps")[0];
    Infos_Temps.innerHTML = '<img class="Info_Icon" alt="Durée" src="../../../images/clock.png"> '+' En ligne depuis '+read_time();
    const Infos_Auteur = document.getElementsByClassName("Infos_Auteur")[0];
    Infos_Auteur.innerHTML = '<img class="Info_Icon" alt="Auteur" src="../../../images/author.png">'+' Par '+actus_liste[index]["author"];
}